...
public class createQuiz extends HttpServlet {
     ...
     * 
     *  This file inserts the new quiz into the database.
     */
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session == null) {
                ...
                if(validUser){
                    ...
                    String sql = "INSERT INTO `is1025_team6`.`quizes`(`quizName`,`questionCount`,`pointsPossible`,`difficulty`)VALUES('" + quizName + "', 0,0," + difficulty + ");";

                    DbUtilities db = new DbUtilities();
                    db.executeQuery(sql);
                    out.println("Your quiz has been added. <a href='index.html'>Click here to return to the main page</a>.");
