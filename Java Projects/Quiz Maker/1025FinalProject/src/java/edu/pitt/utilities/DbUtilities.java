...
public class DbUtilities {
    ...
    private String dbName = "is1025_team6"; // default database name
    private String dbUserName = "is1025team6"; // login name for the database server
    private String dbPassword = "is1@25f1nalPr@ject"; // password for the database server
